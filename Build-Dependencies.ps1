...
if ( $PSVersionTable.PSVersion -lt '7.2.0' ) {
    Write-Warning 'The hale-deps PowerShell build script requires PowerShell Core 7.2+. Install or upgrade your PowerShell version: https://aka.ms/pscore6'
    exit 0
}
...
function Package-Dependencies {
    ...
    Get-Date -Format "yyyy-MM-dd" | Set-Content -Path share/hale-deps/VERSION
